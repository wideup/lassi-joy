...
<head>
    ...
    <title>Video Tutorials &#8211; Hot Coffee</title>
...
<body class="page videopg body_filled article_style_stretch scheme_original top_panel_show top_panel_above sidebar_hide sidebar_outer_hide preloader vc_responsive">
    ...
    <div class="page_wrap">
                                        ...
                                        <ul class="sub-menu">
                                            <li class="menu-item current-menu-ancestor current-menu-parent menu-item-has-children"><a href="#">Tools</a>
                                                <ul class="sub-menu">
                                                    ...
                                                    <li class="menu-item current-menu-item"><a href="video.html">Video Tutorials</a></li>
                                                </ul>
                                            </li>
        ...
        <div class="top_panel_title top_panel_style_3 title_present breadcrumbs_present scheme_original">
            <div class="top_panel_title_inner top_panel_inner_style_3 title_present_inner breadcrumbs_present_inner breadcrumbs_1">
                <div class="content_wrap">
                    <h1 class="page_title">Video Tutorials</h1>
                        ...
                        <section class="post_content">
                                        ...
                                        <div class="wpb_wrapper">
                                            <div class="columns_wrap sc_columns columns_nofluid sc_columns_count_2">
                                                <div class="column-1_2 sc_column_item">
                                                    <h4 class="sc_title sc_title_regular">Dummy data installation</h4>
                                                    <div class="sc_video_player">
                                                        <div class="sc_video_frame" data-width="100%" data-height="659">
                                                            <iframe class="video_frame" src="https://youtube.com/embed/87R1gzeIc8c" width="100%" height="659" frameborder="0" allowFullScreen="allowFullScreen"></iframe>
                                                        </div>
                                                    </div>
                                                </div>
                                                <div class="column-1_2 sc_column_item">
                                                    <h4 class="sc_title sc_title_regular">How to install theme, plugins, child theme</h4>
                                                    <div class="sc_video_player">
                                                        <div class="sc_video_frame" data-width="100%" data-height="659">
                                                            <iframe class="video_frame" src="https://youtube.com/embed/GGueQfGlTO4" width="100%" height="659" frameborder="0" allowFullScreen="allowFullScreen"></iframe>
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="sc_line sc_line_position_center_center sc_line_style_solid margin_top_large margin_bottom_tiny"></div>
                                        </div>
                                    </div>
                                </div>
                            </div>
                                    ...
                                    <div class="vc_column-inner ">
                                        <div class="wpb_wrapper">
                                            <div class="columns_wrap sc_columns columns_nofluid sc_columns_count_2 margin_bottom_huge">
                                                <div class="column-1_2 sc_column_item">
                                                    <h4 class="sc_title sc_title_regular">How to update the theme</h4>
                                                    <div class="sc_video_player">
                                                        <div class="sc_video_frame" data-width="100%" data-height="659">
                                                            <iframe class="video_frame" src="https://youtube.com/embed/_c1qwkUTjpI" width="100%" height="659" frameborder="0" allowFullScreen="allowFullScreen"></iframe>
                                                        </div>
                                                    </div>
                                                </div>
                                                <div class="column-1_2 sc_column_item">
                                                    <h4 class="sc_title sc_title_regular">How to update plugins</h4>
                                                    <div class="sc_video_player">
                                                        <div class="sc_video_frame" data-width="100%" data-height="659">
                                                            <iframe class="video_frame" src="https://youtube.com/embed/Nt3XOFNIK2E" width="100%" height="659" frameborder="0" allowFullScreen="allowFullScreen"></iframe>
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
                                            <a href="https://www.youtube.com/channel/UCnFisBimrK2aIE-hnY70kCA" class="sc_button sc_button_square sc_button_style_border_1 sc_button_size_medium aligncenter">View More</a>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            <div class="vc_row wpb_row vc_row-fluid">
                                <div class="wpb_column vc_column_container vc_col-sm-12">
                                    <div class="vc_column-inner ">
                                        <div class="wpb_wrapper">
                                            <div id="sc_call_to_action_980" class="sc_call_to_action sc_call_to_action_accented sc_call_to_action_style_2 sc_call_to_action_align_left margin_top_medium margin_bottom_null">
                                                <div class="columns_wrap">
                                                    ...
                                                    <div class="sc_call_to_action_buttons sc_item_buttons column-1_4">
                                                        <div class="sc_call_to_action_button sc_item_button">
                                                            <a href="#" class="sc_button sc_button_square sc_button_style_border_1 sc_button_size_small">Learn more</a>
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
