...
<head>
    ...
    <title>Page not found &#8211; Hot Coffee</title>
...
<body class="error404 body_filled article_style_stretch layout_excerpt template_excerpt scheme_original top_panel_show top_panel_above sidebar_hide sidebar_outer_hide preloader vc_responsive">
...
<div class="body_wrap">
    <div class="page_wrap">
                                ...
                                <ul id="menu_main" class="menu_main_nav">
                                    ...
                                    <li class="menu-item current-menu-ancestor current-menu-parent menu-item-has-children"><a href="#">Features</a>
                                        <ul class="sub-menu">
                                            ...
                                            <li class="menu-item current-menu-item"><a href="404.html">404 Page</a></li>
                                        </ul>
                                    </li>
        ...
        <div class="top_panel_title top_panel_style_3 title_present breadcrumbs_present scheme_original">
            <div class="top_panel_title_inner top_panel_inner_style_3 title_present_inner breadcrumbs_present_inner breadcrumbs_4">
                <div class="content_wrap">
                ...
                <div class="content">
                    <article class="post_item post_item_404">
                        <div class="post_content">
                            ...
                            <p class="page_description">Can't find what you need? Take a moment and do a search below or start from
                                <a href="index.html">our homepage</a>.
                            </p>
                            <div class="page_go_home">
                                <a href="index.html" class="sc_button sc_button_square sc_button_style_border_1 sc_button_size_large">Home page</a>
                            </div>
                        </div>
                    </article>
                </div>
